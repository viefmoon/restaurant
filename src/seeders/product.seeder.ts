  ...
  const products = [
      ...
      items: [
        ...
        },
        {
          ...
          productVariants: [
            ...
            { id: 'CRV3', name: 'XX', shortName: 'XX', price: 35 },
            { id: 'CRV4', name: 'Indio', shortName: 'Indio', price: 35 },
            { id: 'CRV5', name: 'Modelo', shortName: 'Modelo', price: 35 },
            { id: 'CRV6', name: 'Heineken', shortName: 'Heineken', price: 35 },
            { id: 'CRV7', name: 'Bohemia', shortName: 'Bohemia', price: 35 },
          ],
        },
        {
          id: 'MC',
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'CP', name: 'Capuchino', shortName: 'Capuchino', price: 60 },
        { id: 'CH', name: 'Chocolate', shortName: 'Chocolate', price: 60 },
        {
          id: 'LC',
        ...
        { id: 'MCC', name: 'Mocaccino', shortName: 'Mocaccino', price: 65 },
        {
          id: 'LCR',
          name: 'Latte Caramelo',
          shortName: 'Latte Caramelo',
          price: 65,
        },
        {
          id: 'LCI',
          name: 'Latte Crema Irlandes',
          shortName: 'Latte Crema Irlandes',
          price: 65,
        },
      ],
    },
    {
      subcategoryName: 'Malteadas',
      items: [
        {
          id: 'MALT',
          name: 'Malteada',
          ...
          productVariants: [
            {
              id: 'MALT-AM',
              name: 'Malteada Americano',
              shortName: 'Malt. Americano',
              price: 90,
            },
            {
              id: 'MALT-CH',
              name: 'Malteada Chocolate',
              shortName: 'Malt. Chocolate',
              price: 90,
            },
            {
              id: 'MALT-VA',
              name: 'Malteada Latte de Vainilla',
              shortName: 'Malt. Vainilla',
              price: 90,
            },
          ],
        },
    ...
    },
    {
      ...
      items: [
        ...
        { id: 'CLERI', name: 'Clericot', shortName: 'Clericot', price: 85 },
        ...
        { id: 'MAR', name: 'Margarita', shortName: 'Margarita', price: 80 },
        { id: 'MOJ', name: 'Mojito', shortName: 'Mojito', price: 100 },
        { id: 'PAL', name: 'Paloma', shortName: 'Paloma', price: 85 },
        ...
        { id: 'PINA', name: 'Pinada', shortName: 'Pinada', price: 75 },
        { id: 'RBL', name: 'Ruso Blanco', shortName: 'Ruso Blanco', price: 90 },
        {
          id: 'SV',
        ...
        { id: 'VAMP', name: 'Vampiro', shortName: 'Vampiro', price: 90 },
      ],
    },
    {
