...
export class OrderItem {
  ...
  @OneToMany(
    () => SelectedModifier,
    (selectedModifier) => selectedModifier.orderItem,
    { nullable: true },
  )
  ...
  @OneToMany(
    () => SelectedPizzaFlavor,
    (selectedPizzaFlavor) => selectedPizzaFlavor.orderItem,
  )
  selectedPizzaFlavors: SelectedPizzaFlavor[];

  @OneToMany(
    () => SelectedPizzaIngredient,
    (selectedPizzaIngredient) => selectedPizzaIngredient.orderItem,
  )
  selectedPizzaIngredients: SelectedPizzaIngredient[];

  @OneToMany(
    () => OrderItemUpdate,
    (orderItemUpdate) => orderItemUpdate.orderItem,
    { nullable: true },
  )
